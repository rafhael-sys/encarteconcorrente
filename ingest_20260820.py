#!/usr/bin/env python3
"""Ingestao da janela de 2026-08-20 (analise diaria do Claude).
...
canon: canonicalizacao por nrm_tokens (mesma logica de ingest_20260819.py);
...
DRY_RUN por padrao. Rode 'python3 ingest_20260820.py commit' p/ gravar.
"""
import json
import os
import re
...
def main() -> None:
    """Ingesta acoes/produtos/canon da janela 2026-08-20."""
