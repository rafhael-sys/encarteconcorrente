#!/usr/bin/env python3
"""Ingestao da janela de 2026-08-07.

Consome data/_extract/w0807_*.json (formato RICO por post, escrito pelos
...
Mesmas regras das janelas anteriores (ver ingest_20260806b.py):
...
DRY_RUN por padrao. Rode 'python3 ingest_20260807.py commit' p/ gravar.
"""
import json
import os
import re
...
# --- carrega extracao RICA (w0807_*.json) ---
...
# ---------- relatorio ----------
print("=" * 72)
print("DRY_RUN" if DRY_RUN else "COMMIT", "- ingest_20260807")
print("=" * 72)
...
if DRY_RUN:
    print("\n(dry-run: nada gravado. rode 'python3 ingest_20260807.py commit')")
    sys.exit(0)

# ================= COMMIT =================
for f in ("data/actions.json", "data/products.json", "data/canon.json"):
    shutil.copy(path(f), path(f + ".bak-20260807"))
