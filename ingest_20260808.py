#!/usr/bin/env python3
"""Ingestao da janela de 2026-08-08.

Consome data/_extract/w0808_*.json (formato RICO por post, escrito pelos
...
DRY_RUN por padrao. Rode 'python3 ingest_20260808.py commit' p/ gravar.
"""
import json
import os
import re
...
# ---------- relatorio ----------
print("=" * 72)
print("DRY_RUN" if DRY_RUN else "COMMIT", "- ingest_20260808")
print("=" * 72)
...
if DRY_RUN:
    print("\n(dry-run: nada gravado. rode 'python3 ingest_20260808.py commit')")
    sys.exit(0)

# ================= COMMIT =================
for f in ("data/actions.json", "data/products.json", "data/canon.json"):
    shutil.copy(path(f), path(f + ".bak-20260808"))
