...
if [ "${FILA_N:-0}" -eq 0 ]; then
  ...
  # --model opus: o modelo mais capaz, por escolha do dono — a análise é o
  # coração da operação e aqui confiabilidade vale mais que economia de cota.
